...
This is Happier *consuming* MCP. If instead you want an editor or automation to
drive Happier itself, that is the other direction:
[Happier MCP (external)](/extending/happier-as-mcp-server).
...
- **Native MCP delivery** on backends with native MCP support, including Claude, Codex, OpenCode, Gemini, Kiro, Devin, and compatible custom ACP backends
