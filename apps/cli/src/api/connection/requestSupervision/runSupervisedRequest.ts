...
export async function runSupervisedRequest<T>(params: Readonly<{
  ...
  // HTTP operation outcomes do not own socket health. Only an explicitly classified readiness
  // probe may publish connection-wide retry/offline evidence; ordinary requests still publish
  // terminal authentication loss because credentials are shared across transports.
