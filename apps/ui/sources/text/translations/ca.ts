...
export const ca: TranslationStructure = {
    ...
    connectedServices: {
        subscription: {
            ...
            renewalUnknown: "Desconeguda",
            renews: ({ date }: { date: string }) => `Es renova el ${date}`,
            ends: ({ date }: { date: string }) => `Finalitza el ${date}`,
            renewsInDays: ({ days }: { days: number }) => `Es renova en ${days} ${days === 1 ? 'dia' : 'dies'}`,
            endsInDays: ({ days }: { days: number }) => `Finalitza en ${days} ${days === 1 ? 'dia' : 'dies'}`,
            periodEnds: ({ date }: { date: string }) => `El període actual finalitza el ${date}`,
            period: ({ start, end }: { start: string; end: string }) => `${start} – ${end}`,
            periodStarted: ({ date }: { date: string }) => `Va començar el ${date}`,
            accessUntil: ({ date }: { date: string }) => `L’accés continua fins al ${date}`,
            checked: ({ time }: { time: string }) => `Comprovat a les ${time}`,
            lastKnown: ({ summary }: { summary: string }) => `Última informació: ${summary}`,
            unavailable: "Detalls de la subscripció no disponibles",
            refreshFailed: "No s’han pogut actualitzar els detalls de la subscripció. Es mostra l’última informació coneguda.",
            outdated: "Els detalls de la subscripció poden estar desactualitzats.",
        ...
        pools: {
            ...
            detail: {
                ...
                quotaLimitsAll: 'Tots els límits informats',
                quotaLimitsAllDescription: 'Utilitza tots els límits informats pels comptes activats del grup; els nous límits s’hi inclouen automàticament.',
                quotaLimitsRefreshing: ({ count }: { count: number }) => `S’estan actualitzant ${count} ${count === 1 ? 'compte activat' : 'comptes activats'}; la llista pot ser incompleta.`,
                quotaLimitsSelected: ({ count }: { count: number }) => `${count} ${count === 1 ? 'límit seleccionat' : 'límits seleccionats'}`,
                quotaLimitsUnavailable: 'Els límits apareixen després d’actualitzar els comptes.',
                quotaLimitsSearch: 'Cerca límits d’ús',
                quotaLimitNotReportedWithId: ({ id }: { id: string }) => `No informat actualment per cap compte activat · ID del proveïdor: ${id}`,
                quotaLimitProviderTitle: 'Límit del proveïdor',
                quotaLimitDetails: ({ windowCount, windowSummary, accountCount, totalAccountCount }: { windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} finestres · ` : ''}${accountCount} de ${totalAccountCount} comptes activats`,
                quotaLimitModelDetails: ({ model, windowCount, windowSummary, accountCount, totalAccountCount }: { model: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${model} · ${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} finestres · ` : ''}${accountCount} de ${totalAccountCount} comptes activats`,
                quotaLimitProviderDetails: ({ id, windowCount, windowSummary, accountCount, totalAccountCount }: { id: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} finestres · ` : ''}${accountCount} de ${totalAccountCount} comptes activats · ID: ${id}`,
  ...
  newSession: {
    ...
    sessionsList: {
        ...
        reminders: {
            ...
            managePresets: 'Gestiona els predefinits', managePresetsMessage: 'Canvia el nom, l’ordre o elimina les opcions desades.',
            presetName: 'Nom del predefinit', movePresetUp: 'Mou amunt', movePresetDown: 'Mou avall',
            noPresets: 'Cap predefinit desat', noPresetsMessage: 'Desa’n un quan triïs un recordatori personalitzat.',
        },
    ...
    toolView: {
      ...
      files: {
        ...
        fileActions: {
            selectEntireFileForCommit: 'Selecciona tot el fitxer per al commit',
