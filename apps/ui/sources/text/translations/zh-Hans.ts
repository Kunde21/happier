...
export const zhHans: TranslationStructure = {
  ...
  connectedServices: {
    ...
    pools: {
      ...
      detail: {
        ...
        quotaLimitsAll: "所有已报告的限制",
        quotaLimitsAllDescription: "使用池中已启用账号报告的所有限制；新报告的限制会自动包含。",
        quotaLimitsRefreshing: ({ count }: { count: number }) => `正在刷新 ${count} 个已启用账号；限制列表可能仍不完整。`,
        quotaLimitsSelected: ({ count }: { count: number }) => `已选择 ${count} 项`,
        quotaLimitsUnavailable: "刷新账户数据后会显示使用限制。",
        quotaLimitsSearch: "搜索使用限制",
        quotaLimitNotReportedWithId: ({ id }: { id: string }) => `当前没有已启用账号报告 · 提供方 ID：${id}`,
        quotaLimitProviderTitle: "提供方限制",
        quotaLimitDetails: ({ windowCount, windowSummary, accountCount, totalAccountCount }: { windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} 个窗口 · ` : ''}${totalAccountCount} 个已启用账号中有 ${accountCount} 个报告`,
        quotaLimitModelDetails: ({ model, windowCount, windowSummary, accountCount, totalAccountCount }: { model: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${model} · ${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} 个窗口 · ` : ''}${totalAccountCount} 个已启用账号中有 ${accountCount} 个报告`,
        quotaLimitProviderDetails: ({ id, windowCount, windowSummary, accountCount, totalAccountCount }: { id: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} 个窗口 · ` : ''}${totalAccountCount} 个已启用账号中有 ${accountCount} 个报告 · ID：${id}`,
        advancedTitle: "高级",
  ...
  sessionsList: {
    ...
    reminders: {
      ...
      managePresets: '管理预设', managePresetsMessage: '重命名、排序或移除已保存的提醒选项。',
      presetName: '预设名称', movePresetUp: '上移预设', movePresetDown: '下移预设',
      noPresets: '没有已保存的预设', noPresetsMessage: '下次选择自定义提醒时即可保存。',
    },
