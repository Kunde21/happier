...
export const en = {
    ...
    connectedServices: {
        subscription: {
            ...
            renews: ({ date }: { date: string }) => `Renews ${date}`,
            ends: ({ date }: { date: string }) => `Ends ${date}`,
            renewsInDays: ({ days }: { days: number }) => `Renews in ${days} day${days === 1 ? '' : 's'}`,
            endsInDays: ({ days }: { days: number }) => `Ends in ${days} day${days === 1 ? '' : 's'}`,
            periodEnds: ({ date }: { date: string }) => `Current period ends ${date}`,
            period: ({ start, end }: { start: string; end: string }) => `${start} – ${end}`,
            periodStarted: ({ date }: { date: string }) => `Started ${date}`,
            accessUntil: ({ date }: { date: string }) => `Access continues until ${date}`,
            checked: ({ time }: { time: string }) => `Checked ${time}`,
            lastKnown: ({ summary }: { summary: string }) => `Last known: ${summary}`,
            unavailable: "Subscription details unavailable",
            refreshFailed: "Could not refresh subscription details. Showing last known information.",
            outdated: "Subscription details may be out of date.",
        ...
        pools: {
            ...
            detail: {
                ...
                quotaLimitsAll: 'All reported limits',
                quotaLimitsAllDescription: 'Uses every limit reported by enabled pool accounts; newly reported limits are included automatically.',
                quotaLimitsRefreshing: ({ count }: { count: number }) => `Refreshing ${count} enabled ${count === 1 ? 'account' : 'accounts'}; reported limits may still be incomplete.`,
                quotaLimitsSelected: ({ count }: { count: number }) => `${count} selected ${count === 1 ? 'limit' : 'limits'}`,
                quotaLimitsUnavailable: 'Usage limits appear after account data is refreshed.',
                quotaLimitsSearch: 'Search usage limits',
                quotaLimitNotReportedWithId: ({ id }: { id: string }) => `Not currently reported by an enabled pool account · Provider ID: ${id}`,
                quotaLimitProviderTitle: 'Provider allowance',
                quotaLimitDetails: ({ windowCount, windowSummary, accountCount, totalAccountCount }: { windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} windows · ` : ''}${accountCount} of ${totalAccountCount} enabled ${totalAccountCount === 1 ? 'account' : 'accounts'}`,
                quotaLimitModelDetails: ({ model, windowCount, windowSummary, accountCount, totalAccountCount }: { model: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${model} · ${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} windows · ` : ''}${accountCount} of ${totalAccountCount} enabled ${totalAccountCount === 1 ? 'account' : 'accounts'}`,
                quotaLimitProviderDetails: ({ id, windowCount, windowSummary, accountCount, totalAccountCount }: { id: string; windowCount: number; windowSummary: string | null; accountCount: number; totalAccountCount: number }) => `${windowSummary ? `${windowSummary} · ` : windowCount > 1 ? `${windowCount} windows · ` : ''}${accountCount} of ${totalAccountCount} enabled ${totalAccountCount === 1 ? 'account' : 'accounts'} · Provider ID: ${id}`,
    ...
    sessionsList: {
        ...
        reminders: {
            ...
            customMessage: 'Enter a local date and time',
            ...
            managePresets: 'Manage presets', managePresetsMessage: 'Rename, reorder, or remove your saved reminder choices.',
            presetName: 'Preset name', movePresetUp: 'Move preset up', movePresetDown: 'Move preset down',
            noPresets: 'No saved presets', noPresetsMessage: 'Save one the next time you choose a custom reminder.',
        },
